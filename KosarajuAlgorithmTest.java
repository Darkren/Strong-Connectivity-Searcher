...
public class KosarajuAlgorithmTest {
    ...
    public void testKosarajuAlg () {
        ...
        KosarajuAlgorithm kosarajuSearcher = new KosarajuAlgorithm(graph);
        ArrayList<ArrayList<Integer>> components = kosarajuSearcher.findComponents();
